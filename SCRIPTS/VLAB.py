...
k = 0
firebaseConfig = {
  'apiKey': "AIzaSyDp9v2GxY4IESW3ZO63ChmzUyU5IFF4L1s",
  'authDomain': "authdemo-db955.firebaseapp.com",
  'databaseURL': "https://authdemo-db955-default-rtdb.firebaseio.com",
  'projectId': "authdemo-db955",
  'storageBucket': "authdemo-db955.appspot.com",
  'messagingSenderId': "819759226275",
  'appId': "1:819759226275:web:5a53cdbd8ac38c9fe6ce16",
  'measurementId': "G-YYJ8EMM5GR"
}
...
#"")
    ...
    def check_password(self):
        ...
        global k
        global user_dets
        '''login_status, user_dets,''' 
        k = sheets.loginverify(log_name, log_pass)
        login_status=auth.sign_in_with_email_and_password(log_name,log_pass)   
        user_dets=log_name 
        if login_status:
            if(user_dets == None):
                msg = QMessageBox()
